    ...
    <>
      <footer className="dq-footer">
        ...
        <div className="dq-shell dq-footer-grid">
          ...
          <div><h3>Explore</h3><Link href="/about">About</Link><Link href="/services">Services</Link><Link href="/events">Events &amp; Academy</Link><Link href="/careers">Careers</Link><Link href="/contact">Contact</Link></div>
