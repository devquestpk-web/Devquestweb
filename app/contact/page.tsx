    ...
    <div className="dq-contact-page">
      ...
      <section className="dq-shell dq-contact-card">
        <aside className="dq-contact-info">
          ...
          <div className="dq-contact-lines"><a href="tel:+923704489589"><Phone /> +92 370 448 9589</a><a href="mailto:devquestpk@gmail.com"><Mail /> devquestpk@gmail.com</a><span><MapPin /> Capital Territory, Islamabad, Pakistan</span></div>
