...
export default function EventsPage() {
  ...
  return (
    <>
      <section className="page-hero events-hero"><div className="page-hero-shape" /><div className="shell page-hero-grid"><div><p className="eyebrow eyebrow-light"><Sparkles /> EVENTS & ACADEMY</p><h1>Learn together. Build what comes <span>next.</span></h1><p>Practical sessions, campus experiences, and community-led programs for students and early-career developers across Pakistan.</p><div className="hero-actions"><a className="button button-light" href={whatsapp} target="_blank" rel="noreferrer">Get event updates <ArrowRight /></a><a className="button button-outline-light" href="#featured-events">Explore events</a></div></div><div className="event-ticket"><div className="ticket-top"><span>COMING SOON</span><Rocket /></div><h2>Innovate Pakistan 2.0</h2><p>Technology experiences made to spark useful ideas and real collaboration.</p><div className="ticket-meta"><span><Globe2 /> Hybrid format</span><span><Users /> Open community</span><span><CalendarDays /> Details coming soon</span></div><div className="ticket-code">DEVQUEST / 2026</div></div></div></section>

      <section className="section section-light"><div className="shell featured-program"><div className="program-visual"><div className="program-ring ring-one" /><div className="program-ring ring-two" /><Rocket /><strong>INNOVATE<br />PAKISTAN 2.0</strong></div><div className="program-copy"><p className="eyebrow">COMING SOON</p><h2>Big ideas belong in the room.</h2><p>Innovate Pakistan 2.0 brings physical gatherings and virtual webinars into one accessible series—connecting students with practical topics, experienced voices, and new collaborators.</p><div className="program-meta"><span><MapPin /> Campus + online</span><span><Clock3 /> Focused sessions</span><span><Trophy /> Participation opportunities</span></div><a className="button button-primary" href={whatsapp} target="_blank" rel="noreferrer">Ask about the next session <ArrowUpRight /></a></div></div></section>
