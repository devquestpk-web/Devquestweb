...
const portals = [
  ...
  { name: "Student Portal", status: "Live workspace", copy: "Learning paths, events, certificates, opportunities, and student progress in one connected space.", href: "/portal/student", icon: GraduationCap, tone: "student" },
];
